                ...
                <div class="row">
                            ...
                            <li class="list-group-item">
                                ...
                                <span>
                                    <?php if ($peminjaman["approve"] == 1): ?>
                                        <span class="badge bg-success mt-3">Approve</span>
                                    <?php elseif ($peminjaman["approve"] == 2): ?>
                                        <span class="badge bg-warning mt-3">Belum Approve</span>
                                    <?php else: ?>
                                        <span class="badge bg-danger mt-3">Ditolak</span>
                                    <?php endif; ?>
                                </span>
                                ...
                                <span>
                                    <?php if ($peminjaman["status_peminjaman"] == 1): ?>
                                        <span class="badge bg-success mt-3">Sudah Dikembalikan</span>
                                    <?php else: ?>
                                        <span class="badge bg-danger mt-3">Belum Dikembalikan</span>
                                    <?php endif; ?>
                                </span>
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-6 col-12 my-auto text-end">
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <a href="dashboard.php" class="btn btn-sm btn-primary text-white"><i
                                    class="material-icons opacity-10">arrow_left</i>
                                Kembali</a>
                            <?php if ($peminjaman["approve"] == 2 || $peminjaman["approve"] == 3): ?>
