<?php
$peminjaman_yet_approve = query("SELECT * FROM peminjaman WHERE approve = 2");
$total_peminjaman_yet_approve = count($peminjaman_yet_approve);
?>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="../view_peminjaman/peminjaman.php">
                    ...
                    <?php if ($total_peminjaman_yet_approve > 0): ?>
                        <span class="badge bg-success mx-2">
                            <?= $total_peminjaman_yet_approve; ?>
                        </span>
                    <?php endif; ?>
                </a>
            </li>
            ...
            <?php if ($user["role_id"] == 1): ?>
                <li class="nav-item">
                    <a class="nav-link text-white " href="../view_siswa/siswa.php">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
