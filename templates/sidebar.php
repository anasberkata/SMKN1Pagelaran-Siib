<aside
    ...
    <div class="w-auto">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-primary" href="../view_admin/dashboard.php">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="../view_admin/pengajuan.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="../view_admin/inventaris.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
